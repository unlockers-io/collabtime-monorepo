    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            "ui:z-50 ui:inline-flex ui:w-fit ui:max-w-xs ui:origin-(--transform-origin) ui:items-center ui:gap-1.5 ui:rounded-md ui:bg-foreground ui:px-3 ui:py-1.5 ui:text-xs ui:text-background ui:has-data-[slot=kbd]:pr-1.5 ui:data-closed:animate-out ui:data-closed:fade-out-0 ui:data-closed:zoom-out-95 ui:data-open:animate-in ui:data-open:fade-in-0 ui:data-open:zoom-in-95 ui:data-[side=bottom]:slide-in-from-top-2 ui:data-[side=inline-end]:slide-in-from-left-2 ui:data-[side=inline-start]:slide-in-from-right-2 ui:data-[side=left]:slide-in-from-right-2 ui:data-[side=right]:slide-in-from-left-2 ui:data-[side=top]:slide-in-from-bottom-2 ui:**:data-[slot=kbd]:relative ui:**:data-[slot=kbd]:isolate ui:**:data-[slot=kbd]:z-50 ui:**:data-[slot=kbd]:rounded-sm ui:data-[state=delayed-open]:animate-in ui:data-[state=delayed-open]:fade-in-0 ui:data-[state=delayed-open]:zoom-in-95",
            className,
          )}
          {...props}
        >
