  ...
  const content = (
    ...
    >
      <div className="relative">
        <div
          className="flex size-6 shrink-0 items-center justify-center border border-border bg-secondary text-(length:--text-caption-xs) font-semibold text-secondary-foreground sm:size-7 sm:text-xs"
          title={member.name}
        >
        ...
        {dayOffset !== 0 && (
          <div className="absolute -right-1 -bottom-0.5 flex size-4 items-center justify-center bg-warning font-mono text-(length:--text-micro) font-bold text-warning-foreground sm:size-5 sm:text-xs">
