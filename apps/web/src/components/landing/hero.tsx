...
const Hero = () => (
  <Section className="pt-12 sm:pt-24">
    <div className="flex flex-col gap-16 sm:gap-24">
      <div className="grid items-end gap-10 lg:grid-cols-hero lg:gap-20">
        <h1 className="max-w-(--container-measure-11) font-display text-6xl leading-hero-compact font-semibold tracking-hero text-balance sm:text-8xl">
          Find the hour everyone is awake
        </h1>

        <div className="flex flex-col items-start gap-7 lg:pb-2">
          <p className="max-w-(--container-measure-42) text-lg leading-relaxed text-pretty text-muted-foreground sm:text-xl">
