...
const ProductPreview = () => {
  ...
  return (
    <div className="rounded-(--frame-radius) bg-primary/15 p-(--frame-padding) outline-1 -outline-offset-1 outline-primary/35 [--frame-padding:--spacing(2)] [--frame-radius:var(--radius-xl)]">
